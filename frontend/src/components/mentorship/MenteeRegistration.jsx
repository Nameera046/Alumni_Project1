...
export default function MenteeRegistrationForm() {
  ...
  const handleChange = (e) => {
    ...
    // For areaOfInterest, enforce max 50 characters
    if (name === "areaOfInterest" && value.length > 50) {
  ...
  const validateForm = () => {
    ...
    if (!formData.areaOfInterest) newErrors.areaOfInterest = "Please enter your area of interest";
    if (formData.areaOfInterest && formData.areaOfInterest.length > 50) 
      newErrors.areaOfInterest = "Area of interest cannot exceed 50 characters";
    ...
    try {
      ...
      if (res.ok) {
        ...
        setTimeout(() => {
          ...
          if (userEmail) {
            // Navigate to mentorship dashboard with email parameter
      ...
      <div className="form-container">
        ...
        <div className="form-card">
          ...
          <div className="form-content">
            ...
            {/* Area of Interest - Manual input with max 50 characters */}
            <div className="form-group">
              ...
              <input
                ...
                maxLength={50}
                className={`input ${errors.areaOfInterest ? "input-error" : ""}`}
                disabled={submitting || submitted}
              />
              {errors.areaOfInterest && <span className="error-text">{errors.areaOfInterest}</span>}
              {formData.areaOfInterest && (
                <small style={{ color: formData.areaOfInterest.length > 45 ? "#f59e0b" : "#6b7280", fontSize: "12px" }}>
                  {formData.areaOfInterest.length}/50 characters
                </small>
              )}
            </div>
